...
export function mockCostOverview(params = {}) {
  ...
  const modelShare = [
    ...
    { name: "MiniMax-M2.7", tokens: Math.round(1_200_000 * multiplier), value: 16.1, fill: "#2563eb" },
    { name: "GLM 5.1", tokens: Math.round(662_100 * multiplier), value: 8.9, fill: "#3b82f6" },
  ];
  ...
  // 每日按模型拆分
  const modelsForTrend = ["Gemini 3.1 Pro", "Opus 4.6", "MiniMax-M2.7", "GLM 5.1"];
